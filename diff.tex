...
%DIF ADD Paper_ttbarH_Draft.tex                               Mon Feb 29 22:42:46 2016
\pdfoutput=1
\usepackage{graphicx}
%\usepackage{dcolumn}
\usepackage{amsfonts}
...
the
  former case and }\DIFdelend \DIFaddbegin \DIFadd{with deviations between the $\kpt = \pm 1$ cases typically
being of order }\DIFaddend $20\sigma$\DIFdelbegin \DIFdel{in the latter.  }%DIFDELCMD < \par %%%
\DIFdelend \DIFaddbegin \DIFadd{.
}{\bf \DIFadd{(KK: I guess what we're calculating here is the
...
\DIFaddbegin {\bf \DIFadd{(KK: Is the result from the previous sentence used somewhere?)}}
\DIFaddend The
...
the numerators of the }{\bf \DIFadd{(KK: did I reword this correctly?)}}
\DIFadd{asymmetries are all }\DIFaddend linear in both
$\kp$ and $\kpt$, \DIFdelbegin \DIFdel{it is }\DIFdelend \DIFaddbegin \DIFadd{they }\DIFaddend expected to vanish in these cases. However, we
will show in the next section \DIFaddbegin {\bf \DIFadd{(KK: subsection?)}}
\DIFaddend that there exist angular distributions
derived from the TPs that are actually suitable \DIFdelbegin \DIFdel{to distinguish }\DIFdelend \DIFaddbegin \DIFadd{for distinguishing between }\DIFaddend these
two hyphothesis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
