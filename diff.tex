...
%DIF ADD Paper_ttbarH_Draft.tex                                Sat Feb 13 16:29:43 2016
\pdfoutput=1
\usepackage{graphicx}
%\usepackage{dcolumn}
\usepackage{amsfonts}
...
diagrams }\DIFaddend are displayed in Fig.~\ref{fig1}, \DIFdelbegin \DIFdel{where the two first rows correspond respectively to }\DIFdelend \DIFaddbegin \DIFadd{with the first two
rows containing the }\DIFaddend $q\bar{q}$ and $gg$ \DIFdelbegin \DIFdel{s-channels whereas
}\DIFdelend \DIFaddbegin \DIFadd{$s$-channel diagrams, and
}\DIFaddend the last one \DIFdelbegin \DIFdel{depicts }\DIFdelend \DIFaddbegin \DIFadd{depicting }\DIFaddend the $gg$ \DIFdelbegin \DIFdel{t-channels}\DIFdelend \DIFaddbegin \DIFadd{$t$-channel diagrams}\DIFaddend . By exchanging the gluon
...
boson, \DIFdelbegin \DIFdel{whereas }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend $d\Gamma(t(n_t)\to b{\ell}^+\nu_{\ell})$ and
