...
%DIF ADD Paper_ttbarH_Draft.tex                              Wed Mar  2 14:58:01 2016
\pdfoutput=1
\usepackage{graphicx}
%\usepackage{dcolumn}
\usepackage{amsfonts}
...
$1.69$-$3.86$, \DIFdelbegin \DIFdel{in contrast to }\DIFdelend \DIFaddbegin \DIFadd{while for $\epsilon_2$ they are in }\DIFaddend the range $0.53$-$1.16$\DIFdelbegin \DIFdel{obtained for $\epsilon_2$.  The main impact on }\DIFdelend \DIFaddbegin \DIFadd{.
  ...
  mixed-CP scenarios.)}}
\DIFadd{The leading source of }\DIFaddend the deviation from the functional
form proposed in Eq.~(\ref{eq27}) appears to be \DIFdelbegin \DIFdel{caused by }\DIFdelend the $\Delta
...
above ranges for $\chi^2/\mathrm{d.o.f}$ \DIFdelbegin \DIFdel{modify to }\DIFdelend \DIFaddbegin \DIFadd{become }\DIFaddend $0.75$-$1.14$ and
...
relaxed.  \DIFaddbegin \DIFadd{Also, 
Fig.~\ref{fig7} shows the angular
distributions, along with the fit curves, for the $\mathrm{CP}$-mixed
cases with the $\Delta R_{\ell\ell}$ cut turned off.
}\DIFaddend The results for the TP $\epsilon_3$ are \DIFdelbegin \DIFdel{pretty }\DIFdelend \DIFaddbegin \DIFadd{relatively }\DIFaddend similar to
those for $\epsilon_2$\DIFdelbegin \DIFdel{but with opposite sign in }\DIFdelend \DIFaddbegin \DIFadd{, except that }\DIFaddend the phase shifts \DIFdelbegin \DIFdel{of
the }\DIFdelend \DIFaddbegin \DIFadd{have the opposite
sign in the }\DIFaddend $\mathrm{CP}$-mixed \DIFdelbegin \DIFdel{hypotheses and hence }\DIFdelend \DIFaddbegin \DIFadd{cases.  Given this similarity
}\DIFaddend we do not include \DIFdelbegin \DIFdel{them
here. In addition, we show in Fig.~\ref{fig7} the angular
distributions along with the fit curves for both $\mathrm{CP}$-mixed
cases when no cut is imposed in $\Delta R_{\ell\ell}$}\DIFdelend \DIFaddbegin \DIFadd{the results for the $\epsilon_3$ distribution
here}\DIFaddend . 
