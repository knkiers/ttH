...
%DIF ADD Paper_ttbarH_Draft.tex                              Wed Mar  9 15:18:51 2016
\pdfoutput=1
\usepackage{graphicx}
%\usepackage{dcolumn}
\usepackage{amsfonts}
...
envisioned for the HL-LHC, and taking into account
only statistical uncertainties,
{\bf (KK: do we need to define the HL-LHC?)}
...
\DIFdelbegin \DIFdel{plausible within }\DIFdelend \DIFaddbegin \DIFadd{is reduced to be consistent with that expected
in }\DIFaddend the short term \DIFdelbegin \DIFdel{LHC is considered}\DIFdelend \DIFaddbegin \DIFadd{at the LHC}\DIFaddend .
...
\begin{table}[H]
  ...
  two \DIFaddbeginFL \DIFaddFL{``}\DIFaddendFL $\mathrm{CP}$-mixed\DIFaddbeginFL \DIFaddFL{'' }\DIFaddendFL cases (defined by
  $\kp=1$ and $\kpt=\pm 1$).}
\label{table1}
\begin{center}
...
\DIFaddbegin \DIFadd{effectively }\DIFaddend able to distinguish the $\mathrm{CP}$-mixed cases by
...
potential pseudoscalar ($\kpt$) top-Higgs couplings.
We have tested the
...
leading to a discrimination of the $\mathrm{CP}$-mixed cases
by up to $\sim 16\sigma$.\par
