...
with an effective separation of $\sim 20\sigma$ {\bf (N: In previous version it said ``statistical level" because we wanted 
  to stress that we are not considering systematic uncertainties.
  KK: This was why I added the new phrase, ``and taking into account
  only statistical uncertainties.''  You can certainly
  change this back if you like,
  though.  The previous way of wording it seemed not completely fluid,
  so I was trying to find a way of rewording it.)}.  In
