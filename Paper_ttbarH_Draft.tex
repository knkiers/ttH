...
are based on triple product (TP) structures {\bf (N: correlations?)} that we extract
...
promising observable can disentangle the hypotheses {\bf (N: scenarios?)} $\kp=1,\kpt=\pm 1$
...
to test the sign of $\kpt/\kp$ within that context.
{\bf (KK: maybe reword this sentence a bit\ldots?)}
