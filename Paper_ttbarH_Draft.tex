...
{\bf (KK: Do we mean the adjoint spinor, related by $C \psi^T$,
  or whatever?, N: It is $\psi^{\dagger}\gamma^0$. I'm using the name given in Eq(2.28) of Bjorken and Drell's book.)}
...
$\kp$ and $\kpt$, they {\bf are} expected to vanish in these cases. However, we
