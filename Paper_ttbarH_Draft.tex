...
{\bf (KK: Did we do 4 fits for each $\epsilon$?  Or only 2?  If only 2, maybe
  ...
  mixed-CP scenarios.)}
The leading source of the deviation from the functional
form proposed in Eq.~(\ref{eq27}) appears to be the $\Delta
R_{ll}$ cut that we have imposed. In fact, when this cut is turned off, the
above ranges for $\chi^2/\mathrm{d.o.f}$ become $0.75$-$1.14$ and
...
The results for the TP $\epsilon_3$ are relatively similar to
...
we do not include the results for the $\epsilon_3$ distribution
here. 
