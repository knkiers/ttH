...
diagrams are displayed in Fig.~\ref{fig1}, with the first two
rows containing the $q\bar{q}$ and $gg$ $s$-channel diagrams, and
the last one depicting the $gg$ $t$-channel diagrams. By exchanging the gluon
...
boson, and $d\Gamma(t(n_t)\to b{\ell}^+\nu_{\ell})$ and
