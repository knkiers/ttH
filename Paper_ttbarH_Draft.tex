...
with an effective separation of $\sim 20\sigma$. In
...
$\epsilon_4 = \epsilon_3-\epsilon_2$.  {\bf We have constructed
...
Sec.~\ref{sec3.1} {\bf is slightly less sensitive than $\langle \epsilon_1\rangle$,
 $\langle \epsilon_2\rangle$ and $\langle \epsilon_3\rangle$},
       {\bf (KK: is my explicit reference to $\epsilon_2$ and $\epsilon_3$ correct?  I think so\ldots.)}
{\bf with values $-4.32$, $1.11$ and $7.23$ for the cases
...
{\bf We have also studied the associated angular distributions. Specifically, 
we have analized the $\Delta\phi(\ell^+,\ell^-)$ distribution in the $t\tbar H$ rest frame,
