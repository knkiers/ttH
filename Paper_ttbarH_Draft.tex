...
and $\kpt\neq 0$ parameterize a $\mathrm{CP}$-odd Higgs boson. \par
%%%%%%%%%%%%%%%%%%%% Figura 1%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In this subsection we focus on the gluon fusion contributions
...
$\kp$ and $\kpt$, they expected to vanish in these cases ({\bf ``..they are expected to.."? Maybe it's a typo? we are not sure}). However, we
